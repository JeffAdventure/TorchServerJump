...
namespace ServerLinkMod
{
    ...
    public static class GridExtensions
    {
        ...
        {
            if (!Block.IsWeldable() && !Block.IsProjectable()) return;
            if (Block.StockpileAllocated)
                Block.GetMissingComponents(MissingList);
            else
            {
                if (Block.IsFullIntegrity) return;
        ...
        public static Dictionary<string, int> ReadMissingComponents(this List<IMySlimBlock> Blocks)
        {
    ...
    public static class TypeHelpers
    {
        ...
        /// </summary>
        public static void SortByType<TI, TO1, TO2>(this IEnumerable<TI> Collection, IList<TO1> Type1, IList<TO2> Type2) where TI : class where TO1 : class, TI where TO2 : class, TI
        {
        ...
        /// </summary>
        public static void SortByType<TI, TO1, TO2, TO3>(this IEnumerable<TI> Collection, IList<TO1> Type1, IList<TO2> Type2, IList<TO3> Type3) where TI : class where TO1 : class, TI where TO2 : class, TI where TO3 : class, TI
        {
            foreach (TI Item in Collection)
            {
                TO1 Type1Item = Item as TO1;
        ...
        /// </summary>
        public static void SortByType<TI, TO1, TO2, TO3, TO4>(this IEnumerable<TI> Collection, IList<TO1> Type1, IList<TO2> Type2, IList<TO3> Type3, IList<TO4> Type4) where TI : class where TO1 : class, TI where TO2 : class, TI where TO3 : class, TI where TO4 : class, TI
        {
            foreach (TI Item in Collection)
            {
                TO1 Type1Item = Item as TO1;
